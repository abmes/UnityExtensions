...
namespace Abmes.UnityExtensions
{
    public static class FactoryFuncExtensionMethods
    {
        ...
        {
            return container.RegisterTypeEx<TResult>().ByFactoryFuncLazy(factoryFunc);
        }
        ...
        {
            return container.RegisterTypeEx<TResult>().ByFactoryFuncLazy<TParam1>(factoryFunc, resolvedParameters);
        }
        ...
        {
            return container.RegisterTypeEx<TResult>().ByFactoryFuncLazy<TParam1, TParam2>(factoryFunc, resolvedParameters);
        }
        ...
        {
            return container.RegisterTypeEx<TResult>().ByFactoryFuncLazy<TParam1, TParam2, TParam3>(factoryFunc, resolvedParameters);
        }
        ...
        {
            return container.RegisterTypeEx<TResult>().ByFactoryFuncLazy<TParam1, TParam2, TParam3, TParam4>(factoryFunc, resolvedParameters);
        }
    }
}
