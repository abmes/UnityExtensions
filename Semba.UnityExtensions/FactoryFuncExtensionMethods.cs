...
namespace Semba.UnityExtensions
{
    ...
    {
        public static IUnityContainer RegisterTypeByFactoryFunc<TResult>(this IUnityContainer container, Func<TResult> factoryFunc, params ResolvedParameter[] resolvedParameters)
        {
            return container.RegisterType<TResult>(new InjectionParamFactory<TResult>(factoryFunc, resolvedParameters));
        }
        ...
        {
            return container.RegisterType<TResult>(new InjectionParamFactory<TParam1, TResult>(factoryFunc, resolvedParameters));
        }
        ...
        {
            return container.RegisterType<TResult>(new InjectionParamFactory<TParam1, TParam2, TResult>(factoryFunc, resolvedParameters));
        }
        ...
        {
            return container.RegisterType<TResult>(new InjectionParamFactory<TParam1, TParam2, TParam3, TResult>(factoryFunc, resolvedParameters));
        }
        ...
        {
            return container.RegisterType<TResult>(new InjectionParamFactory<TParam1, TParam2, TParam3, TParam4, TResult>(factoryFunc, resolvedParameters));
        }
    }
}
